...
//!
//! This is a thin wrapper around [`nerd_fonts_gtk::icons::export::export_icons`].
//!
//! Usage:
//! ```sh
//! cargo run --features export --bin export_icons -- <font.ttf> -o resources/
//! ```
...
fn main() {
    let cli = Cli::parse();
    let count = nerd_fonts_gtk::icons::export::export_icons(&cli.font, &cli.output).expect("Failed to export icons");
