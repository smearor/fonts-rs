...
impl IconSet {
    ...
    pub fn detect(icon_name: &str) -> Self {
        match icon_name {
    ...
    /// Returns a human-readable label for this icon set.
    ///
    /// # Examples
    ///
    /// ```
    /// use nerd_fonts_model::IconSet;
    ///
    /// assert_eq!(IconSet::FontAwesome.label(), "Font Awesome");
    /// assert_eq!(IconSet::MaterialDesign.label(), "Material Design Icons");
    /// ```
    #[allow(dead_code)]
    pub const fn label(self) -> &'static str {
        match self {
            IconSet::MaterialDesign => "Material Design Icons",
            IconSet::FontAwesome => "Font Awesome",
            IconSet::Devicons => "Devicon",
            IconSet::Codicons => "Codicons",
            IconSet::Octicons => "Octicons",
            IconSet::Weather => "Weather Icons",
            IconSet::FontAwesomeExtended => "Font Awesome Extended",
            IconSet::Seti => "Seti",
            IconSet::Linux => "Linux",
            IconSet::PowerlineExtra => "Powerline Extra",
            IconSet::Powerline => "Powerline",
            IconSet::Custom => "Custom",
            IconSet::Extra => "Extra",
            IconSet::Pomicons => "Pomicons",
            IconSet::Alpha => "Alpha",
            IconSet::Iec => "IEC",
            IconSet::Checkbox => "Checkbox",
            IconSet::File => "File",
            IconSet::Heart => "Heart",
            IconSet::Image => "Image",
            IconSet::Indentation => "Indentation",
            IconSet::Music => "Music",
            IconSet::Near => "Near",
            IconSet::NonMarkingReturn => "Non-Marking Return",
            IconSet::Exit => "Exit",
            IconSet::Other => "Other",
        }
    }
