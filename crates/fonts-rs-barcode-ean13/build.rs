...
fn main() -> std::io::Result<()> {
    ...
    let font_path = "resources/LibreBarcodeEAN13Text-Regular.ttf";
    ...
    if needs_export {
        ...
        let count = Ean13Definition::export_glyphs(Path::new(font_path), Path::new(build_constants::RESOURCES_DIR))?;
