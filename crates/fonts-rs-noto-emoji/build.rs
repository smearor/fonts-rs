...
fn generate_metadata(
    ...
    keywords_code.push_str("pub static KEYWORDS: phf::Map<&'static str, &'static [GlyphKeyword]> = phf::phf_map! {\n");

    categories_code.push_str("// @generated by build.rs — do not edit\n\n");
    categories_code.push_str("/// Categories for each emoji glyph name.\n");
    categories_code.push_str("pub static CATEGORIES: phf::Map<&'static str, GlyphCategory> = phf::phf_map! {\n");
